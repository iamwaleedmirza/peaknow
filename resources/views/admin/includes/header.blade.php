<div id="kt_header" style="" class="header align-items-stretch">
    ...
    <div class="header-brand">
        ...
        <a href="{{route('admin.home')}}">
            <img alt="Logo" src="{{asset('logo/Logo-white.svg')}}" class="h-35px h-lg-50px" />
        </a>
        <!--end::Logo-->
    ...
    <div class="toolbar d-flex align-items-stretch">
        ...
        <div class="align-items-lg-stretch container-fluid d-flex flex-lg-row justify-content-between justify-content-lg-between py-6 py-lg-0">
            <!--begin::Page title-->
            ...
            <div class="d-flex align-items-stretch overflow-auto pt-lg-0">
                ...
                <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        <img src="{{asset('/images/png/profile.png')}}"  alt="user" />
                    </div>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <img alt="Logo" src="{{asset('/images/png/profile.png')}}" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Username-->
                        ...
                        <div class="menu-item px-5 my-1">
                            <a href="{{url('/admin/change-password')}}" class="menu-link px-5"><i class="ti-user m-r-10 text-custom"></i>Change password</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
