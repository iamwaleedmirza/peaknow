<div class="modal fade" tabindex="-1" id="view-subscription-details">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">View Cancelled Subscription Details</h5>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <p><span class="badge badge-light-danger">Cancelled</span></p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="fw-bold">Cancelled Date</label>
                            <p id="date">-</p>
                        </div>
                    </div>
                    <div class="col-md-6">
