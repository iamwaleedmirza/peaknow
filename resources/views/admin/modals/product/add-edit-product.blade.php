...
<div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content refund-cancelled-order-form">
        <div class="modal-header">
            <h3 class="modal-title" id="exampleModalLongTitle">Edit Product Details</h3>
            <!--begin::Close-->
                ...
                <div class="row">
                    <div class="col-md-12 mb-1">
                        <div class="form-group">
                            <span class="form-label fw-bold fs-6 mb-2">Product Name <span class="error-sign">*</span></span>
