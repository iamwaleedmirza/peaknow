...
@section('title','Admin | Refund Policy Page Content')
@section('navbar')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card-box" style="border: none">
                <form action="{{route('pages-content.post','refund_policy')}}" method="post"
                      enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label for="passWord2">Page Content</label>
                        <textarea class="form-control" id="refund_summernote"
                                  name="page_content">{{($content)?$content->refund_policy_page:''}}</textarea>
                    </div>
