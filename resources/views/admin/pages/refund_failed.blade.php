...
@section('title','Admin | Refund Failed')
@section('navbar')
...
@section('content')
            ...
            <table class="table align-middle table-row-dashed gy-5" id="kt_datatable_example_1">
                ...
                <thead>
                    ...
                    <tr class="text-start  fw-bolder text-uppercase gs-0">
                        ...
                        <th class="">Fill Type</th>
                        <th class="">Name</th>
                        <th class=" ">Plan Name</th>
                        <th class=" ">Total Amount</th>
                        <th class=" ">Refunded Amount</th>
                        <th class=" ">Transaction ID</th>
                        <th class=" ">Failed Date</th>
                        <th class=" ">Action</th>
                    </tr>
                    <!--end::Table row-->
                </thead>
    ...
    <!--end::Declined Order Listing-->
    <!-- Page-Title -->

@include('admin.modals.refund-history.view-refund-history-details')
@endsection
@section('js')
        ...
        <script>
            var docType = "Refunded Failed Orders"
        </script>
		<script src="{{asset('admin_assets/assets/js/custom/apps/ecommerce/sales/refund-failed-listing.js')}}"></script>
