...
@section('content')
    ...
    @include('admin.modals.subscription.view-subscription-details')
@endsection
...
@section('js')
    ...
    <script src="{{ asset('admin_assets/assets/js/custom/apps/ecommerce/sales/inactive-sub-listing.js') }}"></script>
@endsection
