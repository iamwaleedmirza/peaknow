...
@section('title', 'Admin | Unshipped Orders')
@section('css')
    <style type="text/css">
...
@include('admin.pages.orders.modals.mark-as-shipped-modal')
...
@section('js')
    ...
    <script src="{{ asset('admin_assets/assets/js/custom/apps/ecommerce/sales/un-shipped-order.js') }}"></script>
@endsection
