...
@section('title', 'Admin | Daily Orders')
@section('css')
...
@section('js')
    ...
    <script>
        var docType = "Daily Orders"
    </script>
    <script src="{{ asset('admin_assets/assets/js/custom/apps/ecommerce/sales/daily-order-listing.js') }}"></script>
@endsection
