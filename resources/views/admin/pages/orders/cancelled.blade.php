...
@section('title', 'Admin | Cancelled Orders')
@section('navbar')
...
@section('js')
    ...
    <script>
        var docType = "Cancelled Orders";
        var today = "{{$today}}";
    </script>
    <script src="{{ asset('admin_assets/assets/js/custom/apps/ecommerce/sales/cancelled-order.js') }}"></script>
