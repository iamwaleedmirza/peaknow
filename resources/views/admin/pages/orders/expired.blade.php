...
@section('title','Admin | Expired Orders')
@section('css')
...
@section('js')
        ...
        <script>
            var docType = "Expired Orders"
        </script>
		<script src="{{asset('admin_assets/assets/js/custom/apps/ecommerce/sales/expired-order.js')}}"></script>
@endsection
