    ...
    <div class="modal fade" id="order_refund_modal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content refund-cancelled-order-form">
                ...
                <form action="{{ route('admin.refund.order') }}" method="post" id="refund-cancelled-order-form">
                    @csrf
                    ...
                    <div class="modal-body">
                        <h5>Are you sure you want to refund this order number: <span id="orderId"></span> ?</h5>
                    </div>
                    <div class="modal-footer">
                        <div class="form-group text-right m-b-0">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                            <button class="ladda-button btn btn-primary" data-style="slide-right" type="button"
                                id="refund-cancelled-order-btn">Proceed</button>
                        </div>
                    </div>
                </form>
            </div>
