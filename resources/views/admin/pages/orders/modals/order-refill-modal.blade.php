    {{-- payout reject model --}}
    <div class="modal fade" id="order_refill_modal" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content refund-declined-order-form">
                <div class="modal-header">
                    <h3 class="modal-title" id="exampleModalLongTitle"
                        style="text-align: center;font-weight: 600;margin-top: -6px;">Order Refill Summary</h3>
                    <!--begin::Close-->
                ...
                <div class="modal-body bg-gray-300" id="order-refill-data">
