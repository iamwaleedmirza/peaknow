...
@section('title', 'Admin | Declined Orders')
@section('navbar')
...
@section('js')
    ...
    <script>
        var docType = "Declined Orders";
        var today = "{{$today}}";
    </script>
    <script src="{{ asset('admin_assets/assets/js/custom/apps/ecommerce/sales/declined-order.js') }}"></script>
