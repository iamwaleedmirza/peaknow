...
@section('title','Admin | Refund History')
@section('navbar')
...
@section('js')
        ...
        <script>
            var docType = "Refunded Orders"
        </script>
		<script src="{{asset('admin_assets/assets/js/custom/apps/ecommerce/sales/refund-listing.js')}}"></script>
