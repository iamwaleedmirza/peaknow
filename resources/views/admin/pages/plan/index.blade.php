    ...
    <div class="card card-flush">
        ...
        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
            ...
            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                   <a href="{{route('admin.add.plan')}}" type="button" class="btn btn-primary">
                    Add New Plan
                    </a>
                </div>
            ...
            <table class="table align-middle table-row-dashed gy-5" id="kt_datatable_example_1">
                ...
                <thead>
                    ...
                    <tr class="text-start  fw-bolder text-uppercase gs-0">
                        ...
                        <th class="min-w-175px">Plan</th>
                        <th class="min-w-175px">Subscription Type</th>
                        <th class="min-w-175px">Medicine Variant</th>
                        <th class="min-w-175px">Plan Title</th>
                        <th class="min-w-175px">Strength</th>
...
@section('js')
    ...
    <script src="{{ asset('admin_assets/assets/js/plan-fetch.js') }}"></script>
