        ...
        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <!--end::Svg Icon-->
                    <input type="text" data-kt-ecommerce-order-filter="search" id="search" class="form-control form-control-solid w-250px ps-14" placeholder="Search User Roles" />
                </div>
                <!--end::Search-->
            </div>
            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
               <a href="{{route('admin.role.add')}}" type="button" class="btn btn-light-primary" id="role-model">
                Add User Role
                </a>
            </div>
        </div>
            ...
            <table class="table align-middle table-row-dashed gy-5" id="kt_datatable_example_1">
                ...
                <thead>
                    ...
                    <tr class="text-start  fw-bolder text-uppercase gs-0">
                        ...
                        <th class="min-w-175px">Created At</th>
                        <th class="min-w-175px">Updated At</th>
...
<script src="{{ asset('admin_assets/js/jquery.validate.min.js') }}"></script>
    ...
    <script src="{{ asset('admin_assets/js/role.js') }}"></script>
@endsection
