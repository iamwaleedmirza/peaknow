...
@section('title', 'Admin | All Subscribers')
@section('navbar')
...
@section('js')
    ...
    <script>
        var docType = "Popup Subscribers"
    </script>
    <script src="{{ asset('admin_assets/assets/js/custom/apps/ecommerce/sales/popup-listing.js') }}"></script>
