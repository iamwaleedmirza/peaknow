    ...
    <div class="modal-content refund-cancelled-order-form">
        <div class="modal-header" style="border-bottom: none;padding-bottom:0px">
            <h3 class="modal-title" id="exampleModalLongTitle"
                style="text-align: center;font-weight: 600;margin-top: -6px;">Customer Password Reset</h3>
            <!--begin::Close-->
        ...
        <form action="{{ route('admin.customers.change.password') }}" method="post"
            ...
            <div class="modal-body">
                ...
                <input type="text" name="user_email" class="form-control form-control-solid mb-2" id="user_email" value="" readonly>
                <!--begin::Main wrapper-->
            ...
            <div class="modal-footer">
                <div class="form-group text-right m-b-0">
                    ...
                    <button class="ladda-button btn btn-primary " data-style="slide-right" type="button"
                        id="customer_reset_modal_formbtn">Change</button>
                </div>
            </div>
        </form>
    </div>
