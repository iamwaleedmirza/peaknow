...
@endif
        ...
        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <!--end::Svg Icon-->
                    <input type="text" data-kt-ecommerce-order-filter="search" id="search" class="form-control form-control-solid w-250px ps-14" placeholder="Search Users" />
                </div>
                <!--end::Search-->
            </div>
            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
               <a href="javascript:void(0)" type="button" class="btn btn-light-primary add-edit-user" id="user-model">
                Add New User
                </a>
            </div>
        </div>
            ...
            <table class="table align-middle table-row-dashed gy-5" id="kt_datatable_example_1">
                ...
                <thead>
                    ...
                    <tr class="text-start  fw-bolder text-uppercase gs-0">
                        ...
                        <th class="min-w-175px">User Role</th>
    ...
    @include('admin.pages.admin_user.modal.add-edit-user')
    @include('admin.pages.admin_user.modal.user-reset-modal')
@endsection
@section('js')
    ...
    <script src="{{ asset('admin_assets/js/admin-users.js') }}"></script>
@endsection
