...
@section('title', 'Admin | Failed Refill Transactions')
@section('css')
...
@section('js')
    ...
    <script>
        var docType = "Failed refill transactions"
    </script>
    <script src="{{ asset('admin_assets/assets/js/custom/apps/ecommerce/sales/failed-refill-transactions.js') }}"></script>
@endsection
