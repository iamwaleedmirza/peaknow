...
@section('title','Admin | Error Codes')
@section('navbar')
            ...
            <table class="table align-middle table-row-dashed gy-5" id="kt_datatable_example_1">
                ...
                <thead>
                    ...
                    <tr class="text-start  fw-bolder text-uppercase gs-0">
                        <th class="">#</th>
                        <th class="min-w-50px">Error Type</th>
...
@section('js')
        ...
        <script>
            var docType = "Error Codes List"
        </script>
		<script src="{{asset('admin_assets/assets/js/custom/apps/ecommerce/sales/peaks-error-listing.js')}}"></script>
