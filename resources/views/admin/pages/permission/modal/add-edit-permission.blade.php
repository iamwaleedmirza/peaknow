<div class="modal fade" id="add-edit-permission-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
<div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content refund-cancelled-order-form">
        <div class="modal-header">
            <h3 class="modal-title" id="exampleModalLongTitle">Add permission</h3>
            <!--begin::Close-->
        ...
        <form id="data_form" class="modal_body" method="post">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <span class="form-label fw-bold fs-6 mb-3">
                       Title  <span class="error-sign">*</span>
                    </span>
                    <textarea class="form-control form-control-solid mb-2 mt-2" id="title" name="title"></textarea>
                </div>
                <div class="form-group">
                    <span class="form-label fw-bold fs-6 mb-3">
                       Module Name <span class="error-sign">*</span>
                    </span>
                    <input type="text" name="module_name" placeholder="Enter Module Name" class="form-control form-control-solid mb-2 mt-2" id="module_name" value="">
                </div>
                <div class="form-group mb-2">
                    <span class="form-label fw-bold fs-6 mb-3">
                       Permission For <span class="error-sign">*</span>
                    </span>
                    <select class="form-select" name="permission_for" id="permission_for">
                        <option value="">Select Permission For</option>
                        @foreach($permission_for as $for)
                ...
                <div class="form-group">
                    <span class="form-label fw-bold fs-6 mb-3">
                       Permission (Route name) <span class="error-sign">*</span>
                    </span>
                    <input type="text" name="name" placeholder="Enter Permission (Route Name)" class="form-control form-control-solid mb-2 mt-2" id="name" value="">
                </div>
            </div>
