<div class="modal fade" id="capture-modal" tabindex="-1" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer border-0">
                <div class="d-flex flex-row gap-3 justify-content-center align-items-center">
                    <button type="button" id="cancel-capture" data-bs-dismiss="modal"
                            class="btn btn-peaks-outline btn-small">
                        Cancel
                    </button>
                    <button type="button" id="capture-btn" class="btn btn-peaks btn-small loaderBtn">
                        Capture
                    </button>
                </div>
            </div>
