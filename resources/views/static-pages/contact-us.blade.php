...
@section('content')
    <div id="contact-us-page" class="section-peaks">

        <section class="section pb-5">
            <div class="section section-contact-us">
                <div class="mb-1 pt-4">
                    <div class="h2 t-bold text-center h-color">
                        Contact us
                    </div>
                </div>
                <div class="row justify-content-center mx-0 px-0">
                    <div class="col-10 col-md-6">
                        ...
                        <p class="text-center t-color t-normal mb-5">
                        ...
                        @else
                            ...
                            <form class="contact-form" method="POST" action="{{ route('contact-us-post') }}"
                                  id="contact_form">
                                @csrf
                            ...
                            <textarea id="message"
                                ...
                                <div class="text-center">
                                    <button type="submit" class="newBtn btn-peaks-hollow submitBTN text-uppercase mt-3">
                                        Submit
                                    </button>
                                </div>
                            </form>
