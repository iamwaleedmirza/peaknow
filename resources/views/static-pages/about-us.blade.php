...
@section('header')
<header class="peaks pages-abt-us section-peaks about-us-header">
    <div class="overlay">
...
@section('content')
    ...
    <div id="about-us" class="section-peaks">

        <section class="section section-our-story pt-2">
                ...
                <div class="col-12 col-md-10 col-lg-8">
                    <div class="our-story-images-wrapper mb-3">
                        <div class="our-img-1">
                            ...
                            <div class="our-img-2">
                                <img class="d-none d-md-block" alt="Our Story Image" src="{{ asset('/images/png/img-our-story-2.png') }}"/>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-center mx-0 px-0">
                <div class="col-10 col-md-8 col-lg-6 text-center">
                    <h2 class="h2 h-color">#BeAtYourPeak</h2>
                    <p class="t-color t-normal">
            ...
            <div class="row justify-content-center mx-0 px-0">
                <div class="col-12 col-xl-10">
                    <div class="d-md-flex flex-row">
                        <div class="pt-md-5">
                            <div class="row justify-content-center mx-0 px-0">
                                <div class="col-10 col-md-8">
                                    ...
                                    <h2 class="need-us-title h-color-light t-semi">Why use Peaks Curative?</h2>
                                    <p class="need-us-desc t-normal t-med">
                        ...
                        <div class="container-fluid mt-md-3 mt-lg-0">
        ...
        <section class="section section-more-benefits">
            <div class="section-body">
                <div class="h2 mb-5 mx-2 text-center">
                ...
                <div class="row justify-content-center mx-0 px-0">
                    <div class="col-10 col-md-6">
                        <div class="row mb-3">
                            <div class="col-2">
                                <img src="{{ asset('/images/svg/green-tick.svg') }}" alt="tick">
                            </div>
                            <div class="col-10">
                                <h5 class="h5 t-med">No more pills!</h5>
                                <p class="t-normal t-color">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-10">
                                <h5 class="h5 t-med">100% online health solution</h5>
                                <p class="t-normal t-color">
