...
@section('content')
    <section class="section section-faq">
        <div class="mt-4">
            <div class="mb-5">
                <h4 class="text-center">Do you have any questions?</h4>
                <p class="text-center">
                ...
                <div class="row justify-content-center mx-0">
                    <div class="col-12 col-md-10 col-lg-8">
                        ...
                        <div class="d-flex justify-content-center align-items-center">
                            <ul class="faq-tab-list nav nav-pills mb-3 d-flex flex-column flex-sm-row justify-content-center align-items-center"
                                id="pills-tab" role="tablist">
                                <li class="nav-item mb-2 mb-sm-0" role="presentation">
                                    <button class="btn btn-peaks-outline active" id="pills-common-ques-tab"
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="btn btn-peaks-outline text-uppercase" id="pills-shipping-ques-tabs"
                                            data-bs-toggle="pill" data-bs-target="#pills-shipping-ques" type="button"
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="pills-common-ques" role="tabpanel"
                                ...
                                <div class="accordion" id="accordionCommonQues">
                                        ...
                                        <div id="collapseOne" class="accordion-collapse collapse show"
                                            ...
                                            <div class="accordion-body">
                                                <p>
                                                    ...
                                                    connect patients with doctors for the purpose of treating Erectile
                                                    Dysfunction in men.
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseTwo" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <p>
                                                    Erectile dysfunction (impotence) is the inability to get and keep an
                                                    erection firm enough for sex. Having erection trouble from time to
                                                    time isn't necessarily a cause for concern. If erectile dysfunction
                                                    is an ongoing issue, however, it can cause stress, affect your
                                                    self-confidence and contribute to relationship problems. Problems
                                                    getting or keeping an erection can also be a sign of an underlying
                                                    health condition that needs treatment and a risk factor for heart
                                                    disease.
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseFive" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <p>
                                                    Peaks Curative is currently available for delivery in the state of
                                        ...
                                        <div id="collapseSex" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <p>
                                                    ...
                                                    that require an RX. You can provide an RX or use the Peaks Curative
                                                    service to get matched to a medical provider that reviews your
                                                    information and would send you a prescription if it is considered
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseSeven" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <p>
                                                    Peaks offers different packages depending on your needs and/or RX.
                                                    We offer recurring monthly subscriptions where the product will be
                                                    mailed to you and we also offer concierge service where the patient
                                                    can customize their order and frequency of delivery. We offer single
                                                    order plans starting at $49 and monthly subscriptions starting at
                                                    $69.
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseEight" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <p>
                                                    Yes. Our doctors and pharmacy are licensed in Florida and New York
                                                    and follow federal regulations on Rx and medication. It is also very
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="headingNinth">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                Do I need to see a healthcare provider in person to use Peaks Curative?
                                            </button>
                                        </h2>
                                        <div id="collapseNinth" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <p>
                                                    ...
                                                    medical history. We will then match you with a licensed provider who
                                                    will review the information and evaluate your treatment options.
                                                    Your provider might follow up with questions which you can respond
                                                    to using our secure online message portal. If your treatment plan
                                                    includes a prescription, it will be delivered to the shipping
                                                    address you provided in discreet packaging in a few days once your
                                        ...
                                        <div id="collapseTen" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <p>
                                                    ...
                                                    or erectile dysfunction-ED). In combination with sexual stimulation,
                                                    tadalafil works by increasing blood flow to the penis to help a man
                                        ...
                                        <div id="collapseEleven" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <p>
                                                    ...
                                                    effects. Tell your doctor if any of these symptoms are severe or do
                                                    not go away: headache, indigestion or heartburn, nausea, diarrhea,
                                                    flushing, pain in the stomach, back, muscles, arms or legs, cough.
                                                    ...
                                                    information) blurred vision changes in color vision (seeing a blue
                                                    tinge on objects or having difficulty telling the difference between
                                                    blue and green) sudden decrease or loss of hearing (see below for
                                                    more information) ringing in ears, erection that lasts longer than 4
                                                    hours, dizziness, chest pain, hives, rash, difficulty breathing or
                                                    swallowing, swelling of the face, throat, tongue, lips, eyes, hands,
                                                    feet, ankles, or lower legs, blistering or peeling of skin.

                                                    Everyone responds differently to medications and treatments, so If
                                                    you have any symptoms or concerns please contact us at
                                                    <a class="t-link" href="mailto:support@peakscurative.com">support@peakscurative.com</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div id="collapse12" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <p>
                                                    ...
                                                    Sildenafil can also be used to treat pulmonary arterial hypertension
                                        ...
                                        <div id="collapse13" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <p>
                                                    ...
                                                    trouble telling blue and green colors apart may also occur. If any
                                                    of these effects persist or worsen, tell your doctor or pharmacist
                                                    promptly. To reduce the risk of dizziness and lightheadedness, get
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapse14" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <p>
                                                    Sildenafil works within an hour of taking the medication and for its
                                                    full effect, should be taken on an empty stomach. The effects of
                                                    Sildenafil generally last four to five hours. Our Tadalafil has two
                                                    formulations – one that can be taken 'as required', and one that can
                                                    be taken daily.The 'as required' Tadalafil (generic Cialis) has an
                                                    advantage over Sildenafil, it lasts a lot longer – up to 36 hours
                                                    (compared with 4-5 hours for Sildenafil). Some men prefer this as it
                                                    allows for more spontaneity. Tadalafil also works faster than
                                                    Sildenafil – it generally works within 30 minutes, though for some
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapse16" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <p>
                                                    Prescription treatments can not be refunded or returned. If an error
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapse17" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <p>
                                                    Peaks Curative is currently available only in Florida. Our team is
                                                    working hard to be available in the whole United States. If you are
                                                    in one state we currently don’t ship to, please register on the
                                                    “Contact Us” page and you will get 30% off on your subscription when
                                        ...
                                        <div id="collapse19" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <p>
                                                    ...
                                                    contact us at
                                                    <a class="t-link" href="mailto:support@peakscurative.com">support@peakscurative.com</a>
                                                    or through our website and our team will get in touch with you as
                                                    soon as possible.
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div id="collapse20" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <p>
                                                    ...
                                                    other brands. Our team works really hard to provide a service that
                                                    is accessible, making it way cheaper for most patients compared to
                            ...
                            <div class="tab-pane fade" id="pills-shipping-ques" role="tabpanel"
                                ...
                                <div class="accordion" id="accordionShippingQues">
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="headingOne">
                                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                    data-bs-target="#collapseOne" aria-expanded="true"
                                        ...
                                        <div id="collapseOne" class="accordion-collapse collapse show"
                                            ...
                                            <div class="accordion-body">
                                                <p>
                                                    Each state has different telemedicine laws and PEAKS CURATIVE staff
                                                    is working diligently to be available in all 50 states. If you are
                                                    in one of the states where we currently do not ship to, please share
                                                    your email address on the "GET STARTED" page and we will notify you
                                        ...
                                        <div id="collapseTwo" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <p>
                                                    ...
                                                    States. International shipping will be available in the near future.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseFour" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <p>
                                                    We are here to help. If the order is lost in the mail, we are able
                                                    to reship free of charge one time to the same address. Reasons why
                                                    you may not have received your package yet:
                                                </p>
                                                <ol>
                                                    <li>
                                                        Refer to your USPS tracking number sent to your email to check
                                                        the status of your package. There may be a delay in shipment.
                                                    </li>
                                                    <li>
                                                        The shipping address is invalid. Please log back into your
                                                        account and check that the shipping address provided is correct.
                                                        Please notify us that the shipping address is incorrect and we
                                                        will be happy to assist.
                                                    </li>
                                                    <li>
                                                        Your package is returning due to invalid address, refusal, or
                                        ...
                                        <div id="collapseFive" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <p>
                                                    ...
                                                    Monday-Thursday for guaranteed delivery if placed before 12PM EST.
                                                    Orders placed after this time will be sent the next business day.
                                                    Please note that PEAKS CURATIVE treatment includes prescription
                                                    medication, so each order or change in subscription must be reviewed
                                                    by our provider team. This process can take 1-2 business days. For
                                                    this reason, please ensure that any future requests for changes are
                                                    made 3-5 business days before your next renewal so that the correct
                                                    shipment will be sent out. At PEAKS CURATIVE, patient safety is our
                                                    number one priority. All customer profiles must go through a medical
                                                    review that usually takes 24-48 hours. Once your medication has been
                                                    approved it will be processed and will ship your medication shortly
                                                    thereafter. You will receive an email that contains tracking
                                                    information as soon as it ships. If your treatment is being shipped
