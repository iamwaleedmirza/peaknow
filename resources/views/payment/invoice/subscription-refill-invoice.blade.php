...
<div class="invoice-box">
    <table cellpadding="0" cellspacing="0">
                ...
                <table>
                    <tr>
                        <td>
                            ...
                            <br/>
                            <strong>Refill Number:</strong> {{ $order['refill_number'] }} (#PC-{{ $order['order_no'] }}) <br/>
                            <strong>Refill Date:</strong> {{  \Carbon\Carbon::parse($order['refill_date'])->format('M d, Y') }}
                        </td>
                        <td class="text-right">
        ...
        <tr class="item">
            ...
            <td class="billPeriod">{{ \Carbon\Carbon::parse($order['refill_date'])->format('F d, Y') }} to {{\Carbon\Carbon::parse($order['refill_end_date'])->format('F d, Y') }}</td>
