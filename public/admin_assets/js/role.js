    ...
    var initDatatable = function () {
        dt = $("#kt_datatable_example_1").DataTable({
            ...
            columns: [
                ...
                {data: 'name',width:"80%"},
                {data: 'created_at',width:"80%"},
                {data: 'updated_at',width:"80%"},
...
$('#role-model').click(function () {
    $("#modal_loader").hide();
    $('#id').val('0');
    $('#exampleModalLongTitle').text('Add Role');
    $('#add-edit-role-modal').modal('show');
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.status) {
                    ...
                    $('#add-edit-role-modal').modal('hide');
                    Swal.fire({
                        icon: 'success',
...
$(document.body).on('click', '.edit', function () {
    ...
    $('#exampleModalLongTitle').text('Edit role');
    ...
    $.ajax({
        ...
        success: function (response) {
            if(response.status){
                ...
                $('#permission').val(response.data.permission_id).trigger('change')
                $("#modal_loader").hide();
                $(".modal_body").show();
            } else {
                Swal.fire({
