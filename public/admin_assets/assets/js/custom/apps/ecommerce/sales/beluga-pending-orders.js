    ...
    var KTAppEcommerceSalesListing = function() {
        ...
        var initDatatable = function() {
            ...
            datatable = $(table).DataTable({
                ...
                order:[],
                ajax: {
                    url: "/admin/beluga-pending-order",
                    "data": function ( d ) {
                     return $.extend( {}, d, {
...
$('#cancel-reason').on('click', function () {
    if (this.value === 'others') {
        $('#other-reason-wrapper').show();
    } else {
        $('#other-reason-wrapper').hide();
    }
});
...
$("#cancel-form").validate({
    ...
    messages: {
        cancel_reason: {
            required: "Select Cancellation Reason"
        },
        cancel_reason_other:{
    ...
    submitHandler: function (form, event) { // for demo
        ...
        $.ajax({
            type: "POST",
            url: "admin-pending-order-cancel",
            data: formData,
            dataType: "json",
            cache: false,
            contentType: false,
...
$(document.body).on('click', '.send-to-beluga', function () {
    let id = $(this).attr('data-id');
    Swal.fire({
    showLoaderOnConfirm: true,
    title: "Are you sure you want to send order to beluga",
    icon: 'warning',
    showCancelButton: true,
