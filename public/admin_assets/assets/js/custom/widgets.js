        ...
        /***/
            ...
            var KTWidgets = function() {
                ...
                var initChartsWidget3 = function() {
                    ...
                    var getData = document.getElementById("kt_charts_widget_3_week_btn");
                    console.log(getData.getAttribute('data-order-days'));
                    var height = parseInt(KTUtil.css(element, 'height'));
                    var labelColor = KTUtil.getCssVariableValue('--bs-gray-500');
                    var borderColor = KTUtil.getCssVariableValue('--bs-gray-200');
                    ...
                    var options = {
                        series: [{
                            name: 'Order Total',
                            data: JSON.parse(getData.getAttribute('data-order-total'))
                        }],
                        chart: {
                            fontFamily: 'inherit',
                            type: 'area',
                        ...
                        xaxis: {
                            categories: JSON.parse(getData.getAttribute('data-order-days')),
                            axisBorder: {
                                show: false,
                            },
                            axisTicks: {
