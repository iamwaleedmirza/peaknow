    ...
    */
    ...
    snap() {
      if(this._canvasElement!=null){
        ...
        this._canvasElement.height = this._webcamElement.scrollHeight * 3; // this._webcamElement.scrollHeight
        this._canvasElement.width = this._webcamElement.scrollWidth * 3; // this._webcamElement.scrollWidth
        ...
        return this._canvasElement.toDataURL('image/png', 1);
      }
      else{
